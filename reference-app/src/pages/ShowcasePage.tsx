...
const componentCategories = [
  ...
  },
  {
    ...
    description: 'Workflow canvas components',
  },
  {
    id: 'feedback',
    label: 'Feedback',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/60">
            A comprehensive gallery of all UI components in the Open Agent Artel design system.
          </p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          <TabsList className="bg-dark-100 border border-white/10 p-1 flex flex-wrap h-auto">
            {componentCategories.map((cat) => (
              <TabsTrigger
                key={cat.id}
                value={cat.id}
                className="data-[state=active]:bg-green data-[state=active]:text-dark"
              >
                {cat.label}
              </TabsTrigger>
            ))}
          ...
          <TabsContent value="buttons" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">Button Sizes</CardTitle>
                  <CardDescription className="text-white/60">
              ...
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">Button States</CardTitle>
                  <CardDescription className="text-white/60">
          ...
          <TabsContent value="inputs" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">Text Inputs</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
              ...
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">Select & Controls</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
          ...
          <TabsContent value="cards" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="bg-dark-100 border-white/10">
                ...
                <CardContent>
                  <p className="text-white/70">
                    Cards are used to group related content and actions. They provide a clear visual separation.
                  </p>
                </CardContent>
              </Card>
              ...
              <NodeCard
                title="AI Agent Node"
                subtitle="Tools Agent configuration"
          ...
          <TabsContent value="badges" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">Status Badges</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex flex-wrap gap-3">
              ...
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">UI Badges</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex flex-wrap gap-3">
                    <Badge>Default</Badge>
                    ...
                    <Badge className="bg-green text-dark">Success</Badge>
          ...
          <TabsContent value="canvas" className="space-y-6">
            <div className="space-y-6">
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">Canvas Nodes</CardTitle>
                  <CardDescription className="text-white/60">
                    Interactive workflow nodes with ports
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">Connection Lines</CardTitle>
                  <CardDescription className="text-white/60">
                ...
                <CardContent>
                  <div className="relative h-40 bg-dark rounded-lg overflow-hidden border border-white/10">
                    <svg className="absolute inset-0 w-full h-full">
                      <ConnectionLine
                        connection={{ id: 'demo-1', from: 'a', to: 'b', fromPort: 'output', toPort: 'input' }}
                        fromPos={{ x: 50, y: 80 }}
                        toPos={{ x: 300, y: 80 }}
                      />
                      <ConnectionLine
                        connection={{ id: 'demo-2', from: 'a', to: 'b', fromPort: 'output', toPort: 'input' }}
                        fromPos={{ x: 350, y: 80 }}
                        toPos={{ x: 600, y: 80 }}
                        isSelected={true}
                        label="1 item"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-dark-100 border-white/10">
                  <CardHeader>
                    <CardTitle className="text-white">Node Search Palette</CardTitle>
                  </CardHeader>
                  <CardContent>
                    ...
                    <NodeSearchPalette
                      ...
                      onSelectNode={() => setPaletteOpen(false)}
                    />
                  </CardContent>
                </Card>
                ...
                <Card className="bg-dark-100 border-white/10">
                  <CardHeader>
                    <CardTitle className="text-white">Zoom Controls</CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              <Card className="bg-dark-100 border-white/10">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Alert className="border-green/30 bg-green/10">
                    ...
                    <AlertTitle className="text-green">Success</AlertTitle>
                    <AlertDescription className="text-green/80">
                    ...
                    <DialogContent className="bg-dark-100 border-white/10">
                      <DialogHeader>
                        ...
                        <DialogDescription className="text-white/60">
                          This is a dialog component with a title and description.
                        </DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4 pt-4">
                        <p className="text-white/70">
                          Dialogs are used for important information that requires user attention or action.
                        </p>
          ...
          <TabsContent value="data" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">Activity Items</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <ActivityItem
                    title="Workflow Executed"
                    description="AI Agent Workflow completed successfully"
                    timestamp="2 minutes ago"
                    icon={<Check className="w-4 h-4" />}
                    iconClassName="bg-green/20 text-green"
                  />
                  <ActivityItem
                    title="Node Added"
                    description="OpenAI Chat node was added to the workflow"
                    timestamp="15 minutes ago"
                    icon={<Plus className="w-4 h-4" />}
                    iconClassName="bg-blue/20 text-blue"
                  />
                  <ActivityItem
                    title="Execution Failed"
                    description="Memory connection timeout"
              ...
              <Card className="bg-dark-100 border-white/10">
                <CardHeader>
                  <CardTitle className="text-white">Node Type Icons</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-4 gap-4">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-xs text-white/60">AI Agent</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-xs text-white/60">HTTP</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
